  ...
  return (
    <div className='flex flex-row justify-between items-center mb-1.5'>
        ...
        <div className='flex flex-row items-center'>
            <div onClick={copyURLWithParams} className="p-1.5 text-base hover:cursor-pointer text-gray-400 hover:text-gray-900 hover:bg-gray-100 transition-colors duration-150 active:scale-95"><IoUnlinkSharp /></div>
