...
export function PlayfairCipher() {
  ...
  useEffect(() => {
    ...
    try {
      setOutput(processPlayfair(input, key, mode));
    } catch (e: unknown) {
  ...
  return (
    <AdvancedConverter
      ...
      description="Digraph substitution cipher using a [1 5×5 key square 2]. Letters I and J share a cell. Text is encrypted in pairs using same-row, same-column, or rectangle rules. The key square and digraph steps are shown below."
      fromValue={input}
      toValue={output}
