...
import { IoSearch, IoMenu, IoClose, IoLogoGithub } from 'react-icons/io5'
import ThemeToggle from '@/Components/ThemeToggle'
import Logo from '@/Components/Navigation/Logo'
import { REPOSITORY_URL } from '@/lib/third-party-licenses'
      ...
      <div className="flex items-stretch h-12">
        ...
        <div className="flex items-stretch flex-shrink-0">
          ...
          <a
            ...
            title="DevOven on GitHub"
            aria-label="DevOven on GitHub"
            className="hidden sm:flex items-center px-4 border-l border-gray-900 dark:border-white/15 text-gray-500 dark:text-zinc-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-white/5 transition-colors"
          >
      ...
      {menuOpen && (
        <div className="md:hidden border-t border-gray-900 dark:border-white/15">
          ...
          <a
            ...
            rel="noopener noreferrer"
            onClick={() => setMenuOpen(false)}
            className="flex sm:hidden items-center gap-2 px-6 py-3 text-sm font-medium text-gray-500 dark:text-zinc-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-white/5 transition-colors uppercase tracking-wide border-t border-gray-200 dark:border-white/10"
          >
