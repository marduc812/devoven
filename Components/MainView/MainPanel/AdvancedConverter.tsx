    ...
    return (
        <div>
            ...
            <div className="px-8 md:px-12 py-8">
                <TextAreaAnalytics title={props.fromTitle} userInput={props.fromValue} output={false} color={props.backColor} extraLink={props.extraLink} />
                <textarea
                ...
                <TextAreaAnalytics title={props.toTitle} userInput={props.toValue} output={true} color={props.backColor} extraLink={props.extraLink} />
                <textarea
