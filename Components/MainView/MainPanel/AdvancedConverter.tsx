...
import { AdvancedCoversionType, colorName } from '@/types'
...
const AdvancedConverter = (props: AdvancedCoversionType) => {
    ...
    return (
        <div>
            ...
            <div className="px-8 md:px-12 py-8">
                <TextAreaAnalytics title={props.fromTitle} userInput={props.fromValue} output={false} color={props.backColor} onLoadFile={props.inputReadOnly ? undefined : loadFromFile} />
                {props.inputReadOnly ? (
                    <textarea
                ...
                <div className="w-full flex flex-row justify-start items-center py-4 gap-3 flex-wrap">
                    {props.swapLink
                    ...
                    {props.extraElements && (
                        <>
                            {props.swapLink && <div className="h-6 w-px bg-gray-300" />}
                            {props.extraElements}
                        </>
                    )}
                </div>

                <TextAreaAnalytics title={props.toTitle} userInput={props.toValue} output={true} color={props.backColor} />
                <textarea
...
export default AdvancedConverter
