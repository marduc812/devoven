...
export const THIRD_PARTY_LIBRARIES: ThirdPartyLibrary[] = [
    ...
    { name: 'bz2', license: 'MIT', url: 'https://github.com/sheetjs/bz2', used: 'Bzip2 decompression' },
    ...
    { name: 'lzma', license: 'MIT', url: 'https://github.com/nmrugg/LZMA-JS', used: 'LZMA compression and decompression' },
